...
Scenario: SystemMaker clicks the Create Button
    ...
    Scenario: Visiting the Sales Info in ISO Onboarding
    When I Visit the Sales Info
    
    Scenario: the user select a valid date in the "ISO Application Date" field in ISO Onboarding
    When the user select a valid date in the "ISO Application Date" field
	  
	  Scenario: the user select a valid date in the "Agreement Date" field in ISO Onboarding
	  When the user select a valid date in the "Agreement Date" field in ISO
	  
	  Scenario: the "Aggregator Name" field should prompt to select the valid inputs in ISO Onboarding
	  Then the "Aggregator Name" field should prompt to select the valid inputs using sheetname "ISO Regression" and rownumber 0
    
    Scenario: the "NextStep" button should be prompted to click on Sales Info in ISO Onboarding
    Then the "NextStep" button should be prompted to click on Sales Info
     ...
     Scenario: Visiting the Company Info in ISO Onboarding
     When I Visit the Company Info
     
     Scenario: the "Legal Name" field should prompt to enter valid inputs in ISO Onboarding
     Then the "Legal Name" field should prompt to enter valid inputs using sheetname "ISO Regression" and rownumber 0
     
     Scenario: the "Brand Name" field should prompt to enter valid inputs in ISO Onboarding
     Then the "Brand Name" field should prompt to enter valid inputs using sheetname "ISO Regression" and rownumber 0
     
     Scenario: the "Registered Address" field should prompt to enter valid inputs within 230 characters in ISO Onboarding
     ...
     Scenario: the "Registered Pincode" dropdown should prompt to select valid inputs in ISO Onboarding
     Then the "Registered Pincode" dropdown should prompt to select valid inputs using sheetname "ISO Regression" and rownumber 0
     
     Scenario: the "Business Type" dropdown should prompt to select valid inputs in ISO Onboarding
     Then the "Business Type" dropdown should prompt to select valid inputs using sheetname "ISO Regression" and rownumber 0
     
     Scenario: the user selects a valid date in the "Established Year" field in ISO Onboarding
     When the user selects a valid date in the "Established Year" field
     
     Scenario: the "Registered Number" field should prompt to enter valid inputs in ISO Onboarding
     Then the "Registered Number" field should prompt to enter valid inputs using sheetname "ISO Regression" and rownumber 0
     
     Scenario: the "Company PAN" field should prompt to enter valid inputs in ISO Onboarding
     Then the "Company PAN" field should prompt to enter valid inputs using sheetname "ISO Regression" and rownumber 0
     
     Scenario: the "GSTIN" field should prompt to enter valid inputs in ISO Onboarding
     Then the "GSTIN" field should prompt to enter valid inputs using sheetname "ISO Regression" and rownumber 0
     
     Scenario: the "Statement Frequency" dropdown should prompt to select valid inputs on Company Info in ISO Onboarding
     Then the "Statement Frequency" dropdown should prompt to select valid inputs in Company Info using sheetname "ISO Regression" and rownumber 0
     
     Scenario: the "Statement Type" dropdown should prompt to select valid inputs on Company Info in ISO Onboarding
     Then the "Statement Type" dropdown should prompt to select valid inputs in Company Info using sheetname "ISO Regression" and rownumber 0
     
     Scenario: the "Email Domain" field should prompt to enter valid inputs in ISO Onboarding 
     Then the "Email Domain" field should prompt to enter valid inputs using sheetname "ISO Regression" and rownumber 0
     
     Scenario: the "Save" button should be prompted to click on Company Info in ISO Onboarding
     Then the "Save" button should be prompted to click on Company Info
     
     Scenario: the "NextStep" button should be prompted to click on Company Info in ISO Onboarding
     Then the "NextStep" button should be prompted to click on Company Info
 

          Scenario: Visiting the Personal Info in ISO Onboarding
          When I visit the Personal Info
          
          
          Scenario: the "Add" button should be prompted to click on personal info in ISO Onboarding
          Then the "Add" button should be prompted to click in personal info
          
          Scenario: the "Title" dropdown should prompt to select valid inputs on Personal Info in ISO Onboarding
          Then the "Title" dropdown should prompt to select valid inputs in Personal Info using sheetname "ISO Regression" and rownumber 0
            
          Scenario: the "First Name" field should prompt to enter valid inputs in ISO Onboarding
          Then the "First Name" field should prompt to enter valid inputs using sheetname "ISO Regression" and rownumber 0
          
          Scenario: the "Last Name" field should prompt to enter valid inputs in ISO Onboarding
          Then the "Last Name" field should prompt to enter valid inputs using sheetname "ISO Regression" and rownumber 0
          
          Scenario: the user select a valid date in the "Date Of Birth" field on Personal Info in ISO Onboarding
          When the user select a valid date in the "Date Of Birth" field in Personal Info
          
          Scenario: the "PAN" field should prompt to enter valid inputs with PAN Format on Personal Info in ISO Onboarding
          ...
          Scenario: the "Address" field should prompt to enter valid inputs within 230 characters on personal info in ISO Onboarding
          ...
          Scenario: the "Pincode" dropdown should prompt to select valid inputs on Personal Info in ISO Onboarding
          Then the "Pincode" dropdown should prompt to select valid inputs in Personal Info using sheetname "ISO Regression" and rownumber 0
          
          Scenario: the "Mobile Number" field should prompt to enter valid inputs on Personal Info in ISO Onboarding
          ...
          Scenario: the "Email ID" field should prompt to enter valid inputs on Personal Info in ISO Onboarding
          ...
          Scenario: the "Nationality" field should prompt to enter valid inputs in ISO Onboarding
          Then the "Nationality" field should prompt to enter valid inputs using sheetname "ISO Regression" and rownumber 0
          
          Scenario: the "Aadhaar Number" field should prompt to enter valid inputs on Personal Info in ISO Onboarding
          ...
          Scenario: the "Passport" field should prompt to enter valid inputs in ISO Onboarding
          Then the "Passport" field should prompt to enter valid inputs using sheetname "ISO Regression" and rownumber 0
          
          Scenario: the user select a valid date in the "Passport Expiry Date" field on Personal Info in ISO Onboarding
          Then the user select a valid date in the "Passport Expiry Date" field in Personal Info
          
          Scenario: the "Save" button should be prompted to click on Personal Info in ISO Onboarding
          Then the "Save" button should be prompted to click on Personal Info in ISO
          
          Scenario: the "NextStep" button should be prompted to click on Personal Info in ISO Onboarding
          Then the "NextStep" button should be prompted to click on Personal Info
          
                      


 Scenario: Visiting the Communication Info in ISO Onboarding
 When I visit the Communication Info
    Then the "Add" button should be prompted to click
    
    
Scenario: the "Name" field should prompt to enter valid inputs in ISO Onboarding
    Then the "Name" field should prompt to enter valid inputs using sheetname "ISO Regression" and rownumber 0
    
 Scenario: the "Position" field should prompt to enter valid inputs in ISO Onboarding
    Then the "Position" field should prompt to enter valid inputs using sheetname "ISO Regression" and rownumber 0
    
    Scenario: the "Mobile Number" field should prompt to enter valid inputs in ISO Onboarding
    Then the "Mobile Number" field should prompt to enter valid inputs using sheetname "ISO Regression" and rownumber 0 
    
    Scenario: the "Email ID" field should prompt to enter valid inputs in ISO Onboarding
    Then the "Email ID" field should prompt to enter valid inputs using sheetname "ISO Regression" and rownumber 0
    
    Scenario: the "AD User" field should prompt to select Yes or No based on the given input in ISO Onboarding
    Then the "AD User" field should prompt to select Yes or No based on the given input using sheetname "ISO Regression" and rownumber 0
    
    Scenario: the "Save" button should be prompted to click on Communication Info in ISO Onboarding
    Then the "Save" button should be prompted to click on Communication Info
    
    
    Scenario: the "Settlement & Recon Contact Details Add" button should be prompted to click in ISO Onboarding
    ...
    Scenario: The "NextStep" button should prompted to click on Communication Info in ISO Onboarding
    Then The "NextStep" button should prompt a click on Communication Info
           


Scenario: Visiting the Channel Config in ISO Onboarding
...
Scenario: the Channel ISO Onboarding should prompt users to enter valid inputs ISO Onboarding     
 ...
 Scenario: The "NextStep" button should prompted to click on Channel Config in ISO Onboarding
     Then The "NextStep" button should prompted to click on Channel Config in ISO
 
        
   
 
 Scenario: Visiting the KYC in ISO Onboarding  
    When I visit the KYC Config
    
Scenario: the KYC "Company Proof of address" field should prompt a selection based on the uploaded image in the ISO Onboarding   
 ...
 Scenario: Visiting the Discount Rate in ISO Onboarding 
     When I visit the Discount Rate
     
 Scenario: the "Discount Rate" should prompt users to enter valid inputs in ISO Onboarding   
     Then the "Discount Rate" should prompt users to enter valid inputs using the sheet name "Discount Rate ISO"
    
 Scenario: The "NextStep" button should prompted to click on Discount Rate in ISO Onboarding   
...
Scenario: the Settlement Info "ADD" button should be prompted to click in ISO Onboarding    
     Then the Settlement Info "ADD" button should be prompted to click
     
Scenario: the Settlement Info "Channel" dropdown should prompt to select the valid inputs in ISO Onboarding    
     Then the Settlement Info "Channel" dropdown should prompt to select the valid inputs using sheetname "ISO Regression" and rownumber 0
     
Scenario: the Settlement Info "Account Type" dropdown should prompt to select the valid inputs in ISO Onboarding   
     Then the Settlement Info "Account Type" dropdown should prompt to select the valid inputs using sheetname "ISO Regression" and rownumber 0
     
Scenario: the Settlement Info "Bank Account Number" field should prompt to enter valid inputs in ISO Onboarding   
     Then the Settlement Info "Bank Account Number" field should prompt to enter valid inputs using sheetname "ISO Regression" and rownumber 0
     
Scenario: the Settlement Info "IFSC Code" dropdown should prompt to select valid inputs in ISO Onboarding   
     Then the Settlement Info "IFSC Code" dropdown should prompt to select valid inputs using sheetname "ISO Regression" and rownumber 0
     
Scenario: the SettlementInfo "Save" button should be prompted to click in ISO Onboarding   
...
Scenario: the "NextStep" button should prompted to click on Settlement Info in ISO Onboarding     
 ...
 Scenario: Visiting the Whitelabel in ISO Onboarding 
       When I visit the Whitelabel
  
  Scenario: the Whitelabel "ISO Onboarding" dropdown should prompt to select valid inputs in ISO Onboarding   
       Then the Whitelabel "ISO Onboarding" dropdown should prompt to select valid inputs using sheetname "ISO Regression" and rownumber 0
      
   Scenario: the Whitelabel "Sales Team Onboarding" dropdown should prompt to select valid inputs in ISO Onboarding 
       Then the Whitelabel "Sales Team Onboarding" dropdown should prompt to select valid inputs using sheetname "ISO Regression" and rownumber 0
       
     Scenario: the Whitelabel "Allow to Create Merchant User" dropdown should prompt to select valid inputs in ISO Onboarding 
       Then the Whitelabel "Allow to Create Merchant User" dropdown should prompt to select valid inputs using sheetname "ISO Regression" and rownumber 0
       
  Scenario: the Whitelabel "Max Number of platform" field should prompt to enter valid inputs in ISO Onboarding     
       Then the Whitelabel "Max Number of platform" field should prompt to enter valid inputs using sheetname "ISO Regression" and rownumber 0
       
    Scenario: the "NextStep" button should prompted to click on Whitelabel in ISO Onboarding  
 ...
 Scenario: Visiting the Webhooks in ISO Onboarding 
       When I visit the Webhooks
       
       Scenario: the Webhooks "Add" button should be prompted to click in ISO Onboarding 
       Then the Webhooks "Add" button should be prompted to click
       
       Scenario: the Webhooks "Webhook Type" dropdown should prompt to select valid inputs in ISO Onboarding 
       Then the Webhooks "Webhook Type" dropdown should prompt to select valid inputs using sheetname "ISO Regression" and rownumber 0
       
       Scenario: the Webhooks "Webhook URL" field should prompt to enter valid inputs in ISO Onboarding 
       Then the Webhooks "Webhook URL" field should prompt to enter valid inputs using sheetname "ISO Regression" and rownumber 0
       
       Scenario: the Webhooks "Save" button should be prompted to click in ISO Onboarding 
       Then the Webhooks "Save" button should be prompted to click
       
       Scenario: the "NextStep" button should prompted to click on Webhook in ISO Onboarding 
       Then the "NextStep" button should prompted to click on Webhook in ISO
       
    
   
            
 Scenario: System Maker submits the application for verification in ISO Onboarding
  When the System Maker clicks the "Submit for verification" button


       
Scenario: System Maker confirms submission by clicking the "Yes" button in ISO Onboarding
  When the System Maker clicks the "Yes" button to confirm submission
  
          
Scenario: System Maker logs out by clicking profile and log-out button in ISO Onboarding
  When the System Maker clicks on the profile and log-out button

       
Scenario: System Maker handles the pop-up and is redirected to the login page in ISO Onboarding
...
Scenario: System Verifier sees side menu items in Onboarding
 ...
 Scenario: System Verifier Ensure the ISO Status - Inprogress
    When the System Verifier ensure the ISO status "Inprogress" using sheetname "ISO Regression" and rownumber 0
...
Scenario: System Verifier - click on action (Three dot button) and select the view option
  ...
  Scenario: System Verifier checks "Sales Info" and clicks "Verified and Next" in ISO Onboarding
  ...
  Scenario: System Verifier checks "Company Info" and clicks "Verified and Next" in ISO Onboarding
  ...
  Scenario: System Verifier checks "Personal Info" and clicks "Verified and Next" in ISO Onboarding
  ...
  Scenario: System Verifier checks "Communication Info" and clicks "Verified and Next" in ISO Onboarding
  ...
  Scenario: System Verifier checks "Channel Config" and clicks "Verified and Next" in ISO Onboarding
  ...
  Scenario: System Verifier checks "KYC" and clicks "Verified and Next" in ISO Onboarding
...
Scenario: System Verifier checks "Discount Rate" and clicks "Verified and Next" in ISO Onboarding
  ...
  Scenario: System Verifier checks "Settlement Info" and clicks "Verified and Next" in ISO Onboarding
  ...
  Scenario: System Verifier checks "WhiteLabel" and clicks "Verified and Next" in ISO Onboarding
  ...
  Scenario: System Verifier checks "Webhooks" and clicks "Verified and Next" in ISO Onboarding
...
Scenario: System Approver sees side menu items in Onboarding
 ...
 Scenario: System Approver Ensure the ISO Status - Inprogress
    When the System Approver ensure the ISO status "Inprogress" using sheetname "ISO Regression" and rownumber 0
...
Scenario: System Approver - click on action (Three dot button) and select the view option
  ...
  Scenario: System Approver confirms submission by clicking the "Yes" button
   ...
   Scenario: Verify that ISO CPID is generated after changing the status to Approved
    When Verify that ISO CPID is displayed correctly on the "ISO Onboarding List page" using sheetname "ISO Regression" and rownumber 0
